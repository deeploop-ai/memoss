...
**Phase 2a 进行中（M11 ✅）：** Provenance 写回 · E2E 信任测试 · 下一步 `memoss read`（Serial Read）

**Phase 2 规划（2b+）：** Discover · Publish · 混合检索 · Bridge（OKF ↔ 企业目录，Phase 3+）
...
| **Phase 2a** | 0–8 周 | Serial Read、Provenance 闭环、E2E、图片 ingest |
| **Phase 2b** | 8–20 周 | Local Discover、混合检索、publish bundle、Retrieval eval |
| **Phase 3** | 18+ 个月 | 托管平台、Bundle 市场、企业版 |

详细文档：[产品设计 v0.2](docs/product-design.md) · [Phase 1 计划](docs/phase-1-plan.md) · [**Phase 2 计划（个人/小团队）**](docs/phase-2-plan.md) · [Phase 1 技术设计](docs/phase-1-technical-design.md) · [Extraction Skills 设计](docs/extraction-skills-design.md) · [Serial Read 设计](docs/serial-read-design.md) · [CLI 参考](docs/cli-reference.md) · [OKF 规范](docs/okf-spec.md)

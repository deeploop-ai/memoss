...
```typescript
import { capitalize, slugify } from '@memoss/strings';
...
Attempting to import from `@memoss/colors` or `@memoss/async` will result in a linting error due to module boundary constraints.
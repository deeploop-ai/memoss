...
```typescript
import { hexToRgb, rgbToHex, lighten, darken } from '@memoss/colors';
...
Attempting to import from `@memoss/strings` or `@memoss/async` will result in a linting error due to module boundary constraints.
